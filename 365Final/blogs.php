...
<html>
  ...
  <body>
    ...
    <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px" id="Main">
      <h2 class="w3-wide">Daily Hooker</h2>
...
<button  class="w3-button w3-circle w3-purple" id="btnaddtopic" onclick="func(0)">+</button>
	  </label>
 ...
 <label for="slct">Choose category, TODO: change categorys and css label,  show blogs content, delete blog posts, escape keys for mysql(error with certain characters)</label>
    </fieldset>
    <fieldset>
