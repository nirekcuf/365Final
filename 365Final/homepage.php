...
<html>
  ...
  <body>
    ...
    <div class="w3-container w3-content w3-center w3-padding-64" style="max-width:800px" id="Main">
      <h2 class="w3-wide">The Daily Hooker</h2>
    ...
    <div class="ColorNav" id="tour">
      <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
        <h2 class="w3-wide w3-center"><span class="ColText">KNIT HAPPENS...</span></h2>
		<h2  class="w3-wide w3-center"><span class="ColText"> GET AWAY FROM THE KNITTY GRITTY</span></h2>
		<h2  class="w3-wide w3-center"><span class="ColText">AND TAKE A BREAK WITH THE DAILY HOOKER.</span></h2>
      </br> <h5> <p class="w3-center ColText">What if knitting was as interactive and easy
 as The Daily Hooker?</p></h5>
